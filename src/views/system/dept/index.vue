<template>
  <div class="app-container">
    ...
    >
      <el-table-column prop="deptName" label="部署名" width="300"></el-table-column>
      <el-table-column prop="deptNameKana" label="部署カナ名" width="260"></el-table-column>
      <el-table-column prop="orderNum" label="順序" width="80"></el-table-column>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          ...
          <el-button v-if="scope.row.parentId != 0" link type="primary" icon="Delete" @click="handleDelete(scope.row)"
                     v-hasPermi="['system:dept:remove']">削除
          </el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="700px" append-to-body>
      <el-form ref="deptRef" :model="form" :rules="rules" label-width="100px">
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="部署カナ名" prop="deptNameKana">
              <el-input v-model="form.deptNameKana" placeholder="请输入部门名称"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
